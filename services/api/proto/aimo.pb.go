...
var file_proto_aimo_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x32, 0x63, 0x0a, 0x04, 0x61,
...
var file_proto_aimo_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_aimo_proto_goTypes = []interface{}{
	...
	(*Result)(nil),            // 3: grpc_sample.Result
	(*Period)(nil),            // 4: grpc_sample.Period
}
var file_proto_aimo_proto_depIdxs = []int32{
	2, // 0: grpc_sample.getPeriodResponse.response:type_name -> grpc_sample.DefaultResponse
	3, // 1: grpc_sample.getPeriodResponse.result:type_name -> grpc_sample.Result
	4, // 2: grpc_sample.Result.period:type_name -> grpc_sample.Period
	0, // 3: grpc_sample.aimo.getPeriod:input_type -> grpc_sample.getPeriodRequest
	1, // 4: grpc_sample.aimo.getPeriod:output_type -> grpc_sample.getPeriodResponse
